  ...
  <div className="container mx-auto px-4">
    ...
    <div className="grid grid-cols-2 gap-4">
      <div className="p-4">
        ...
        Embodying the row, wayward spirit of rock and roll the Kilburn portable active stereo speaker takes the unmistakable look sound of Marshall unplugs the chords, and takes the show on the road.
